...
<div id="index">
    <div id="title" >
        ...
        <div id="gtitle">
            <a  href="../member/applist.php">应用列表</a>&nbsp;|&nbsp;<a id="applist" href="">移动设备</a>
        </div>
    </div>
    <div id="list">
    ...
    <div id="main">
        <div id="content">
            <table  id="dw"  border="2" >
                ...
                $sql="select * from new_mob_device where stat in (1,2) ORDER BY stat asc,dev_version asc  ";
...
$result1=mysqli_query($conn,$sql);
$row = mysqli_fetch_array($result1);
$index=$row[mobdevice] +1;
$sql="update new_count_num set mobdevice= $index ";
$result1=mysqli_query($conn,$sql);

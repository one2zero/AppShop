...
<div id="index">
    ...
    <div id="list">
        <div id="listdet" class="detail">
            ...
            <div id="add_app" class="detail"><a href="" >我的设备</a></div>
            ...
            <table  id="dw"  border="2" >
                ...
                while($row = mysqli_fetch_array($result1)){
                    ...
                    <tr>
                        ...
                        <td style="line-height:200%" ><?php echo mb_substr($row[use_time],0,10); ?></td>
						<td style="line-height:200%" ><?php echo $row[comments]; ?></td>
                    </tr>
